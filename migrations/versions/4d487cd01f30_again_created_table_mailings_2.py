"""again created table 'mailings_2'

Revision ID: 4d487cd01f30
Revises: 9e588075ffc2
Create Date: 2024-07-21 16:29:21.757419
...
revision: str = '4d487cd01f30'
down_revision: Union[str, None] = '9e588075ffc2'
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('sms_stats_id')
    )
